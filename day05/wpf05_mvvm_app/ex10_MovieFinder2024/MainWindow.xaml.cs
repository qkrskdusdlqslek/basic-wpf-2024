...
namespace ex10_MovieFinder2024
{
    ...
    {
        // flag값
        private bool isFavorite = false; // 즐겨찾기인지 API로 검색한건지 구분 false => openAPI, true => 즐겨찾기 보기
        ...
        {
            string tmdb_apiKey = "9c12bf67510072b2d746715ab440cef2"; //TMDB 사이트에서 제공받은 API키
            ...
            try
            {
                ...
                res = await req.GetResponseAsync(); // 요청한 URL로 결과를 비동기응답
        ...
        private async void BtnAddFavorite_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            if (isFavorite == true) // 즐겨찾기 보기를 한 뒤 영화를 다시 즐겨찾기 하려고 할 때 막음
            {
            ...
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(Helpers.Common.CONNSTRING))
                {
                    ...
                    foreach (MovieItem item in addMovieItems)
                    {
                        ...
                        var cnt = Convert.ToInt32(chkCmd.ExecuteScalar()); // COUNT(*) 등의 1row, 1coloumn 값을 리턴할 때
            ...
            {
                await this.ShowMessageAsync("즐겨찾기", $"즐겨찾기 오류 {ex.Message}");
            }
        ...
        private async void BtnDelFavorite_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            if (isFavorite == false)
            {
                await this.ShowMessageAsync("즐겨찾기", "즐겨찾기한 영화가 아닙니다.");
                return;
            }
        ...
        private async void BtnWatchFavorite_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            trailerWindow.WindowStartupLocation = System.Windows.WindowStartupLocation.CenterOwner;
